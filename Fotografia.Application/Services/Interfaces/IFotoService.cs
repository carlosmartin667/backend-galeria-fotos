...
public interface IFotoService
{
    ...
    Task<ApiResponse<FotoMetadataBulkResponseDto>> CreateMetadataBulkAsync(CrearFotoMetadataBulkRequestDto request, CancellationToken cancellationToken = default);
    ...
    Task<ApiResponse<StorageKeysBulkResponseDto>> GenerateStorageKeysBulkAsync(GenerarStorageKeysBulkRequestDto request, CancellationToken cancellationToken = default);
